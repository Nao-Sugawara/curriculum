...
public class Task1_1{
    ...
    // ①int型の hogeInt という名前の変数を宣言し、値「50」で初期化
        ...
        String hopeString ="テスト";
            // ③下記の処理について、何をしているのかコメントを記入してください
            // [ここへ記述]「double型」の「hogeDouble」という変数を扱い、初期値は0.2という宣言をしている。
        ...
        String hogeString ="合格";
            // ⑥変数 hogeInt の値を表示
        System.out.println ("double =hogeInt =100");
            // ⑦下記の処理について、何をしているのかコメントを記入してください
            // [ここへ記述](hogeString)を標準出力と宣言している
